    ...
    try {
        ...
        products.forEach(p => {
            ...
            if (grid) {
                ...
                let stockBadge = '';
                if (isSoldOut) stockBadge = '<span class="product-badge" style="background:#e74c3c;color:#fff">Sold Out</span>';
                else if (isLowStock) stockBadge = `<span class="product-badge" style="background:#fdcb6e;color:#333">Only ${stock} left!</span>`;
                    ...
                    <div class="product-card${isSoldOut ? ' sold-out' : ''}">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                ...
                                <button class="btn-buy-whatsapp" onclick="buyOnWhatsApp('${safeName}', ${p.price})" ${isSoldOut ? 'disabled style="opacity:0.4;cursor:not-allowed"' : ''}>
